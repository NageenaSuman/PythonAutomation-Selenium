...
from Xedge.excel_data import Data
from Xedge.excel_data import XML
...
driver.get("http://103.107.198.34:8077/aol/user/standardConnect.w3p;resUrl=http%3A%2F%2F103.107.198.34%3A8077%2Faol%2Fbrowse%2FtitleResults.w3p%3Bletter%3DR%3BpNum%3D17%3Btype%3DslAll;url=http%3A%2F%2F103.107.198.34%3A8077%2Faol%2Fsearch%2Fdisplay%2Fview.w3p%3Bpage%253D0%3Bquery%253DCompId%253Ac09a9a9b-1059-42cb-aef9-dd2f38b862f5%3Brec%253D0%3BresUrl%253Dhttp%253A%252F%252F103.107.198.34%253A8077%252Faol%252Fbrowse%252FtitleResults.w3p%253Bletter%253DR%253BpNum%253D17%253Btype%253DslAll")
    ...
    def test_aol(self):
        ...
        for instrument_index, _ in enumerate(Data.instru_list):
            ...
            for icon, _ in enumerate(image_link):
                ...
                elif ("Spent" in data1) or ("RevEd" in data1) or ("Reprint" in data1) or (amd_chk in data1):
